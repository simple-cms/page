...
<aside class="right-side">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">{{ isset($page) ? Lang::get('core::core.edit') : Lang::get('core::core.create') }} {{ Lang::get('page::page.singular') }}</li>
    </ol>
  </section>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="info">
              <div class="form-group">
                {{ Form::label('created_at', Lang::get('core::core.created_at')) }}
                {{ Form::text('created_at', null, ['class' => 'form-control', 'disabled' => 'disabled']) }}
              </div>
              <div class="form-group">
                {{ Form::label('updated_at', Lang::get('core::core.updated_at')) }}
